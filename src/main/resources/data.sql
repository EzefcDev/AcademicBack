CREATE TABLE students(id INT NOT NULL AUTO_INCREMENT, name VARCHAR(128) NOT NULL, lastname VARCHAR(128) NOT NULL, dni INT NOT NULL, student_status int, student_career int, PRIMARY KEY(id));
...
VALUES  ('Alejando', 'Maldonado', 30345789, 1, 1),
        ('Ramiro', 'Juarez', 32345781, 2, 1),
        ('Vanesa', 'Redondo', 23347089, 3, 2),
        ('Mariana', 'Criancelmo', 36245709, 1, 3),
        ('Alejando', 'Maldonado', 30345789, 1, 1),
        ('Ramiro', 'Juarez', 32345781, 2, 1),
        ('Vanesa', 'Redondo', 23347089, 3, 2),
        ('Mariana', 'Criancelmo', 36245709, 1, 3),
        ('Alejando', 'Maldonado', 30345789, 1, 1),
