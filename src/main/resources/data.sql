CREATE TABLE students(id INT NOT NULL AUTO_INCREMENT, name VARCHAR(128) NOT NULL, lastname VARCHAR(128) NOT NULL, dni INT NOT NULL, student_status int, student_career int, delete_at date default null, PRIMARY KEY(id));
